...
export function PageLayout({ children, title }: LayoutProps) {
  return (
    <>
      <Head>
        <title>{title}</title>
                ...
                <div className="flex flex-col lg:flex-row items-center mt-[80px] gap-x-[100px] px-[41px]">
                  <div>
                    ...
                    <p className="sm:text-[20px] sm:text-center lg:text-left text-[14px] text-white">
                      Stay up to date with the latest news, blogs and
                      announcements
                    </p>
                  </div>
                  <div className="flex mt-[10px] md:mt-0 flex-col gap-y-[20px] items-center md:flex-row gap-x-[20px] footer-input">
                    ...
                    <Button
                      text="Subscribe"
                      size="24px"
                      className="bg-white text-[#004AAD] text-[16px] sm:text-[24px] py-[18px] px-[35px]"
                    />
                  </div>
                </div>
                <div
                ...
                >
                  <div>
                    ...
                    <p className="mt-[18px] text-[11px] md:text-[24px] text-white text-justify">
                      ...
                      programmes that can be used to educate youths and help
