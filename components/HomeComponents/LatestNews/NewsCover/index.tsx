  ...
  return (
    <div className="h-full flex flex-col justify-between">
      ...
      <div className="mt-[20px]">
        ...
        <p className="font-bold text-[24px] md2:text-[34px] mt-[6px]">
          8 E-Commerce Email Marketing Best Practices To Boost Your ROI in 2022
        </p>
        <p className="md2:text-[20px] text-[16px] mt-[6px]">
        ...
        <div className="mt-[20px] flex items-center justify-between gap-x-[40px]">
          <p className="font-semibold text-[16px] md2:text-[24px] text-[#DA063F] cursor-pointer">
            Read more...
          </p>
          <p className="font-semibold text-[16px] md2:text-[24px]">
            November 9th 2023
          </p>
        </div>
      </div>
