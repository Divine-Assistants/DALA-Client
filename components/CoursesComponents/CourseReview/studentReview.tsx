    ...
    <div className="grid grid-cols-10 gap-x-[21px]">
      ...
      <div className="col-span-9">
        <div className="flex items-center justify-between">
          <div>
            <p className="font-semibold text-[32px] text-mine">
              Jaymeline Nduka
            </p>
            <p className="font-semibold text-[20px] mt-[5px]">2 Weeks Ago</p>
          </div>
          <img src="/images/More-black.svg"></img>
        </div>
        <p className="font-medium text-[20px] mt-[13px] text-justify">
